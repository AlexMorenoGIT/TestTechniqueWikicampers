...
class __TwigTemplate_cd6fddb2e8544ce41156021624d98c9a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        yield "Wikicampers - Se connecter";
...
<img src=\"";
        // line 7
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/background-login.jpeg"), "html", null, true);
        yield "\" alt=\"Background login\" id=\"background-login\">
...
<form method=\"post\" id=\"login-form\">
    ...
    ";
        ...
        // line 19
        yield "
    <h1 class=\"h3 mb-3 font-weight-normal\" id=\"login-title\">Se connecter</h1>
    <div class=\"username\">
        <label for=\"inputUsername\" class=\"label-login\">Identifiant</label>
        ...
        yield "\" name=\"username\" id=\"inputUsername\" autocomplete=\"username\" required autofocus>
    </div>
    <div class=\"password\">
    ...
    <button class=\"submit-widget\" type=\"submit\">
        Connexion
    </button>
</form>
";
    ...
    {
        return array (  140 => 31,  129 => 23,  123 => 19,  115 => 16,  112 => 15,  110 => 14,  107 => 13,  101 => 11,  99 => 10,  93 => 7,  90 => 6,  80 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %}Wikicampers - Se connecter{% endblock %}

{% block body %}

<img src=\"{{ asset('assets/images/background-login.jpeg') }}\" alt=\"Background login\" id=\"background-login\">
...
{% endblock %}
", "security/login.html.twig", "C:\\Users\\alexm\\Desktop\\DEV\\TestTechniqueWikicampersMORENOAlex\\templates\\security\\login.html.twig");
    }
}
